 ...
 */
export const formatTime = (date: Date | string, format: '12' | '24' = '12'): string => {
  if (!date) return '';
 ...
 */
export const formatDateTime = (date: Date | string, format: '12' | '24' = '12'): string => {
  if (!date) return '';
 ...
 */
export const convertTimeFormat = (timeStr: string, toFormat: '12' | '24'): string => {
  if (!timeStr) return '';
