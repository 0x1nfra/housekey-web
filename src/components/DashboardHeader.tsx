...
import NotificationIcon from "./notifications/ui/NotificationIcon";
...
const DashboardHeader: React.FC = () => {
  ...
  return (
    <header className="px-6 py-4 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative" ref={dropdownRef}>
            <motion.button
              ...
              className="flex items-center gap-3 p-2 hover:bg-gray-100 dark:hover:bg-gray-600/30 rounded-lg transition-colors"
            >
                ...
                >
                  ...
                  <div className="py-2">
                    {menuItems.map((item, index) => (
                      <motion.button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-2 text-left text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-600/30 transition-colors"
                      >
                        <item.icon size={16} />
                  ...
                  <div className="border-t border-gray-100 dark:border-gray-700 pt-2">
                    <motion.button
                      ...
                      className="w-full flex items-center gap-3 px-4 py-2 text-left text-red-600 hover:text-red-700 dark:hover:text-red-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isSigningOut ? (
