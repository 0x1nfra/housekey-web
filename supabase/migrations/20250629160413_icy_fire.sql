/*
  # Add Hub Invitation Accepted Notification

  1. Changes
     - Create a trigger to notify users when their hub invitations are accepted
     - Fix column references to match the actual hub_invitations table schema
